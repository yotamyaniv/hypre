      ...
      char *argv[] )
{
      ...
      /*end lobpcg */
   {
      ...
      hypre_GpuProfilingPopRange();
      hypre_EndTiming(time_index);
      // hypre_PrintTiming("Setup phase times", hypre_MPI_COMM_WORLD); /* TODO */
      hypre_GetLapTiming("Setup phase times","setup.timing.out", hypre_MPI_COMM_WORLD); /* TODO */
      hypre_FinalizeTiming(time_index);
      hypre_ClearTiming();
      ...
      hypre_GpuProfilingPopRange();
      hypre_EndTiming(time_index);
      // hypre_PrintTiming("Solve phase times", hypre_MPI_COMM_WORLD); /*  TODO */
      hypre_GetLapTiming("Solve phase times","solve.timing.out", hypre_MPI_COMM_WORLD); /*  TODO */
      ...
      {
         hypre_printf("\n");
         hypre_printf("Iterations = %d\n", num_iterations); /* change here*/
         hypre_printf("Final Relative Residual Norm = %e\n", final_res_norm);
         hypre_printf("\n");

         hypre_PrintRealToFile("Final Relative Residual Norm", "relres.out", final_res_norm, hypre_MPI_COMM_WORLD);
      }
